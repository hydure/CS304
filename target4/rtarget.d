...
0000000000400e80 <.plt.got>:
  400e80:	ff 25 72 41 20 00    	jmpq   *0x204172(%rip)        # 604ff8 <_DYNAMIC+0x1e0>
...
0000000000400e90 <_start>:
  ...
  400e9d:	50                   	push   %rax
  400e9e:	54                   	push   %rsp
  400e9f:	49 c7 c0 b0 2d 40 00 	mov    $0x402db0,%r8
  400ea6:	48 c7 c1 40 2d 40 00 	mov    $0x402d40,%rcx
...
0000000000400f30 <__do_global_dtors_aux>:
  400f30:	80 3d 81 45 20 00 00 	cmpb   $0x0,0x204581(%rip)        # 6054b8 <completed.6337>
  ...
  400f42:	5d                   	pop    %rbp
  400f43:	c6 05 6e 45 20 00 01 	movb   $0x1,0x20456e(%rip)        # 6054b8 <completed.6337>
  400f4a:	f3 c3                	repz retq 
  400f4c:	0f 1f 40 00          	nopl   0x0(%rax)

0000000000400f50 <frame_dummy>:
  400f50:	48 83 3d b8 3e 20 00 	cmpq   $0x0,0x203eb8(%rip)        # 604e10 <__JCR_END__>
  400f57:	00 
  ...
  400f64:	55                   	push   %rbp
  400f65:	bf 10 4e 60 00       	mov    $0x604e10,%edi
...
0000000000401000 <initialize_target>:
  ...
  40100b:	89 3d c7 44 20 00    	mov    %edi,0x2044c7(%rip)        # 6054d8 <check_level>
  401011:	8b 3d 31 41 20 00    	mov    0x204131(%rip),%edi        # 605148 <target_id>
  401017:	e8 03 1d 00 00       	callq  402d1f <gencookie>
  40101c:	89 05 c2 44 20 00    	mov    %eax,0x2044c2(%rip)        # 6054e4 <cookie>
  401022:	89 c7                	mov    %eax,%edi
  401024:	e8 f6 1c 00 00       	callq  402d1f <gencookie>
  401029:	89 05 b1 44 20 00    	mov    %eax,0x2044b1(%rip)        # 6054e0 <authkey>
  40102f:	8b 05 13 41 20 00    	mov    0x204113(%rip),%eax        # 605148 <target_id>
  ...
  40107a:	48 89 05 ff 43 20 00 	mov    %rax,0x2043ff(%rip)        # 605480 <buf_offset>
  401081:	c6 05 80 50 20 00 72 	movb   $0x72,0x205080(%rip)        # 606108 <target_prefix>
  401088:	83 3d f9 43 20 00 00 	cmpl   $0x0,0x2043f9(%rip)        # 605488 <notify>
  40108f:	74 60                	je     4010f1 <initialize_target+0xf1>
  401091:	83 3d 50 44 20 00 00 	cmpl   $0x0,0x204450(%rip)        # 6054e8 <is_checker>
  ...
  4010ab:	bf a8 2e 40 00       	mov    $0x402ea8,%edi
...
00000000004010fb <main>:
  ...
  401158:	bd aa 2f 40 00       	mov    $0x402faa,%ebp
  40115d:	eb 05                	jmp    401164 <main+0x69>
  40115f:	bd a5 2f 40 00       	mov    $0x402fa5,%ebp
  401164:	48 8b 05 35 43 20 00 	mov    0x204335(%rip),%rax        # 6054a0 <stdin@@GLIBC_2.2.5>
  40116b:	48 89 05 5e 43 20 00 	mov    %rax,0x20435e(%rip)        # 6054d0 <infile>
  ...
  401191:	ff 24 c5 f0 2f 40 00 	jmpq   *0x402ff0(,%rax,8)
  401198:	48 8b 3b             	mov    (%rbx),%rdi
  40119b:	e8 e0 fd ff ff       	callq  400f80 <usage>
  4011a0:	be 6d 32 40 00       	mov    $0x40326d,%esi
  4011a5:	48 8b 3d fc 42 20 00 	mov    0x2042fc(%rip),%rdi        # 6054a8 <optarg@@GLIBC_2.2.5>
  4011ac:	e8 4f fc ff ff       	callq  400e00 <fopen@plt>
  4011b1:	48 89 05 18 43 20 00 	mov    %rax,0x204318(%rip)        # 6054d0 <infile>
  4011b8:	48 85 c0             	test   %rax,%rax
  4011bb:	75 7f                	jne    40123c <main+0x141>
  4011bd:	48 8b 15 e4 42 20 00 	mov    0x2042e4(%rip),%rdx        # 6054a8 <optarg@@GLIBC_2.2.5>
  4011c4:	be b2 2f 40 00       	mov    $0x402fb2,%esi
  4011c9:	48 8b 3d e0 42 20 00 	mov    0x2042e0(%rip),%rdi        # 6054b0 <stderr@@GLIBC_2.2.5>
  ...
  4011e9:	48 8b 3d b8 42 20 00 	mov    0x2042b8(%rip),%rdi        # 6054a8 <optarg@@GLIBC_2.2.5>
  ...
  401204:	48 8b 3d 9d 42 20 00 	mov    0x20429d(%rip),%rdi        # 6054a8 <optarg@@GLIBC_2.2.5>
  40120b:	e8 70 fb ff ff       	callq  400d80 <strtol@plt>
  401210:	41 89 c5             	mov    %eax,%r13d
  401213:	eb 27                	jmp    40123c <main+0x141>
  401215:	c7 05 69 42 20 00 00 	movl   $0x0,0x204269(%rip)        # 605488 <notify>
  40121c:	00 00 00 
  40121f:	eb 1b                	jmp    40123c <main+0x141>
  401221:	40 0f be f6          	movsbl %sil,%esi
  401225:	bf cf 2f 40 00       	mov    $0x402fcf,%edi
  ...
  401254:	be 01 00 00 00       	mov    $0x1,%esi
  401259:	44 89 ef             	mov    %r13d,%edi
  40125c:	e8 9f fd ff ff       	callq  401000 <initialize_target>
  401261:	83 3d 80 42 20 00 00 	cmpl   $0x0,0x204280(%rip)        # 6054e8 <is_checker>
  401268:	74 25                	je     40128f <main+0x194>
  40126a:	44 3b 35 6f 42 20 00 	cmp    0x20426f(%rip),%r14d        # 6054e0 <authkey>
  401271:	74 1c                	je     40128f <main+0x194>
  401273:	44 89 f6             	mov    %r14d,%esi
  401276:	bf 08 2f 40 00       	mov    $0x402f08,%edi
  40127b:	b8 00 00 00 00       	mov    $0x0,%eax
  401280:	e8 6b fa ff ff       	callq  400cf0 <printf@plt>
  401285:	b8 00 00 00 00       	mov    $0x0,%eax
  40128a:	e8 dc 08 00 00       	callq  401b6b <check_fail>
  40128f:	8b 35 4f 42 20 00    	mov    0x20424f(%rip),%esi        # 6054e4 <cookie>
  401295:	bf e2 2f 40 00       	mov    $0x402fe2,%edi
  40129a:	b8 00 00 00 00       	mov    $0x0,%eax
  40129f:	e8 4c fa ff ff       	callq  400cf0 <printf@plt>
  4012a4:	48 8b 3d d5 41 20 00 	mov    0x2041d5(%rip),%rdi        # 605480 <buf_offset>
  4012ab:	e8 eb 0c 00 00       	callq  401f9b <launch>
...
000000000040184f <touch1>:
  ...
  401853:	c7 05 7f 3c 20 00 01 	movl   $0x1,0x203c7f(%rip)        # 6054dc <vlevel>
  40185a:	00 00 00 
  40185d:	bf c6 30 40 00       	mov    $0x4030c6,%edi
  401862:	e8 59 f4 ff ff       	callq  400cc0 <puts@plt>
  401867:	bf 01 00 00 00       	mov    $0x1,%edi
  40186c:	e8 18 05 00 00       	callq  401d89 <validate>
...
00000000004018d1 <hexmatch>:
  ...
  40191c:	be e3 30 40 00       	mov    $0x4030e3,%esi
...
000000000040194f <touch3>:
  ...
  401953:	c7 05 7f 3b 20 00 03 	movl   $0x3,0x203b7f(%rip)        # 6054dc <vlevel>
  40195a:	00 00 00 
  40195d:	48 89 fe             	mov    %rdi,%rsi
  401960:	8b 3d 7e 3b 20 00    	mov    0x203b7e(%rip),%edi        # 6054e4 <cookie>
...
00000000004019b3 <test>:
  ...
  4019c3:	bf 88 31 40 00       	mov    $0x403188,%edi
  4019c8:	b8 00 00 00 00       	mov    $0x0,%eax
  4019cd:	e8 1e f3 ff ff       	callq  400cf0 <printf@plt>
  4019d2:	48 83 c4 08          	add    $0x8,%rsp
  4019d6:	c3                   	retq   

00000000004019d7 <start_farm>:
  4019d7:	b8 01 00 00 00       	mov    $0x1,%eax
  4019dc:	c3                   	retq   

00000000004019dd <getval_379>:
  4019dd:	b8 1e 58 90 90       	mov    $0x9090581e,%eax
  4019e2:	c3                   	retq   

00000000004019e3 <addval_475>:
  4019e3:	8d 87 37 48 89 c7    	lea    -0x3876b7c9(%rdi),%eax
  4019e9:	c3                   	retq   

00000000004019ea <setval_431>:
  4019ea:	c7 07 48 89 c7 c3    	movl   $0xc3c78948,(%rdi)
  4019f0:	c3                   	retq   

00000000004019f1 <getval_398>:
  4019f1:	b8 48 89 c7 92       	mov    $0x92c78948,%eax
  4019f6:	c3                   	retq   

00000000004019f7 <addval_243>:
  4019f7:	8d 87 58 90 c3 1b    	lea    0x1bc39058(%rdi),%eax
  4019fd:	c3                   	retq   

00000000004019fe <addval_289>:
  4019fe:	8d 87 e9 58 94 90    	lea    -0x6f6ba717(%rdi),%eax
  401a04:	c3                   	retq   

0000000000401a05 <addval_467>:
  401a05:	8d 87 a4 48 8d c7    	lea    -0x3872b75c(%rdi),%eax
  401a0b:	c3                   	retq   

0000000000401a0c <getval_372>:
  401a0c:	b8 0c d8 c3 6b       	mov    $0x6bc3d80c,%eax
  401a11:	c3                   	retq   

0000000000401a12 <mid_farm>:
  401a12:	b8 01 00 00 00       	mov    $0x1,%eax
  401a17:	c3                   	retq   

0000000000401a18 <add_xy>:
  401a18:	48 8d 04 37          	lea    (%rdi,%rsi,1),%rax
  401a1c:	c3                   	retq   

0000000000401a1d <addval_165>:
  401a1d:	8d 87 48 89 e0 c2    	lea    -0x3d1f76b8(%rdi),%eax
  401a23:	c3                   	retq   

0000000000401a24 <addval_390>:
  401a24:	8d 87 82 89 c2 c3    	lea    -0x3c3d767e(%rdi),%eax
  401a2a:	c3                   	retq   

0000000000401a2b <addval_141>:
  401a2b:	8d 87 48 89 e0 90    	lea    -0x6f1f76b8(%rdi),%eax
  401a31:	c3                   	retq   

0000000000401a32 <setval_405>:
  401a32:	c7 07 8d ce 08 c0    	movl   $0xc008ce8d,(%rdi)
  401a38:	c3                   	retq   

0000000000401a39 <setval_364>:
  401a39:	c7 07 89 c2 94 d2    	movl   $0xd294c289,(%rdi)
  401a3f:	c3                   	retq   

0000000000401a40 <getval_423>:
  401a40:	b8 2c 81 c2 c3       	mov    $0xc3c2812c,%eax
  401a45:	c3                   	retq   

0000000000401a46 <setval_124>:
  401a46:	c7 07 c8 89 e0 90    	movl   $0x90e089c8,(%rdi)
  401a4c:	c3                   	retq   

0000000000401a4d <addval_292>:
  401a4d:	8d 87 89 ce 60 d2    	lea    -0x2d9f3177(%rdi),%eax
  401a53:	c3                   	retq   

0000000000401a54 <setval_499>:
  401a54:	c7 07 89 c2 90 c3    	movl   $0xc390c289,(%rdi)
  401a5a:	c3                   	retq   

0000000000401a5b <addval_193>:
  401a5b:	8d 87 88 c2 84 c0    	lea    -0x3f7b3d78(%rdi),%eax
  401a61:	c3                   	retq   

0000000000401a62 <setval_239>:
  401a62:	c7 07 8b d1 20 d2    	movl   $0xd220d18b,(%rdi)
  401a68:	c3                   	retq   

0000000000401a69 <setval_347>:
  401a69:	c7 07 88 d1 c3 e3    	movl   $0xe3c3d188,(%rdi)
  401a6f:	c3                   	retq   

0000000000401a70 <addval_432>:
  401a70:	8d 87 48 89 e0 c1    	lea    -0x3e1f76b8(%rdi),%eax
  401a76:	c3                   	retq   

0000000000401a77 <addval_293>:
  401a77:	8d 87 89 d1 38 c0    	lea    -0x3fc72e77(%rdi),%eax
  401a7d:	c3                   	retq   

0000000000401a7e <addval_302>:
  401a7e:	8d 87 89 d1 60 c9    	lea    -0x369f2e77(%rdi),%eax
  401a84:	c3                   	retq   

0000000000401a85 <addval_376>:
  401a85:	8d 87 48 89 e0 91    	lea    -0x6e1f76b8(%rdi),%eax
  401a8b:	c3                   	retq   

0000000000401a8c <addval_286>:
  401a8c:	8d 87 7a de 89 ce    	lea    -0x31762186(%rdi),%eax
  401a92:	c3                   	retq   

0000000000401a93 <getval_403>:
  401a93:	b8 89 c2 c2 5e       	mov    $0x5ec2c289,%eax
  401a98:	c3                   	retq   

0000000000401a99 <setval_440>:
  401a99:	c7 07 f5 48 99 e0    	movl   $0xe09948f5,(%rdi)
  401a9f:	c3                   	retq   

0000000000401aa0 <setval_315>:
  401aa0:	c7 07 09 ce 90 c3    	movl   $0xc390ce09,(%rdi)
  401aa6:	c3                   	retq   

0000000000401aa7 <setval_414>:
  401aa7:	c7 07 8d ce 08 c0    	movl   $0xc008ce8d,(%rdi)
  401aad:	c3                   	retq   

0000000000401aae <setval_450>:
  401aae:	c7 07 8d d1 20 db    	movl   $0xdb20d18d,(%rdi)
  401ab4:	c3                   	retq   

0000000000401ab5 <setval_194>:
  401ab5:	c7 07 89 ce 91 90    	movl   $0x9091ce89,(%rdi)
  401abb:	c3                   	retq   

0000000000401abc <setval_191>:
  401abc:	c7 07 89 ce 18 db    	movl   $0xdb18ce89,(%rdi)
  401ac2:	c3                   	retq   

0000000000401ac3 <setval_131>:
  401ac3:	c7 07 89 ce 90 90    	movl   $0x9090ce89,(%rdi)
  401ac9:	c3                   	retq   

0000000000401aca <getval_185>:
  401aca:	b8 89 c2 c2 52       	mov    $0x52c2c289,%eax
  401acf:	c3                   	retq   

0000000000401ad0 <addval_336>:
  401ad0:	8d 87 89 d1 92 c3    	lea    -0x3c6d2e77(%rdi),%eax
  401ad6:	c3                   	retq   

0000000000401ad7 <getval_433>:
  401ad7:	b8 a9 48 89 e0       	mov    $0xe08948a9,%eax
  401adc:	c3                   	retq   

0000000000401add <setval_455>:
  401add:	c7 07 89 c2 78 d2    	movl   $0xd278c289,(%rdi)
  401ae3:	c3                   	retq   

0000000000401ae4 <setval_155>:
  401ae4:	c7 07 89 d1 08 db    	movl   $0xdb08d189,(%rdi)
  401aea:	c3                   	retq   

0000000000401aeb <getval_180>:
  401aeb:	b8 48 89 e0 c2       	mov    $0xc2e08948,%eax
  401af0:	c3                   	retq   

0000000000401af1 <getval_149>:
  401af1:	b8 99 d1 08 c9       	mov    $0xc908d199,%eax
  401af6:	c3                   	retq   

0000000000401af7 <end_farm>:
  401af7:	b8 01 00 00 00       	mov    $0x1,%eax
  401afc:	c3                   	retq   
  401afd:	0f 1f 00             	nopl   (%rax)

0000000000401b00 <save_char>:
  401b00:	8b 05 fe 45 20 00    	mov    0x2045fe(%rip),%eax        # 606104 <gets_cnt>
  ...
  401b18:	0f b6 b1 b0 34 40 00 	movzbl 0x4034b0(%rcx),%esi
  401b1f:	48 63 ca             	movslq %edx,%rcx
  401b22:	40 88 b1 00 55 60 00 	mov    %sil,0x605500(%rcx)
  401b29:	8d 4a 01             	lea    0x1(%rdx),%ecx
  401b2c:	83 e7 0f             	and    $0xf,%edi
  401b2f:	0f b6 b7 b0 34 40 00 	movzbl 0x4034b0(%rdi),%esi
  401b36:	48 63 c9             	movslq %ecx,%rcx
  401b39:	40 88 b1 00 55 60 00 	mov    %sil,0x605500(%rcx)
  401b40:	83 c2 02             	add    $0x2,%edx
  401b43:	48 63 d2             	movslq %edx,%rdx
  401b46:	c6 82 00 55 60 00 20 	movb   $0x20,0x605500(%rdx)
  401b4d:	83 c0 01             	add    $0x1,%eax
  401b50:	89 05 ae 45 20 00    	mov    %eax,0x2045ae(%rip)        # 606104 <gets_cnt>
  401b56:	f3 c3                	repz retq 

0000000000401b58 <save_term>:
  401b58:	8b 05 a6 45 20 00    	mov    0x2045a6(%rip),%eax        # 606104 <gets_cnt>
  401b5e:	8d 04 40             	lea    (%rax,%rax,2),%eax
  401b61:	48 98                	cltq   
  401b63:	c6 80 00 55 60 00 00 	movb   $0x0,0x605500(%rax)
  401b6a:	c3                   	retq   

0000000000401b6b <check_fail>:
  401b6b:	48 83 ec 08          	sub    $0x8,%rsp
  401b6f:	0f be 35 92 45 20 00 	movsbl 0x204592(%rip),%esi        # 606108 <target_prefix>
  401b76:	b9 00 55 60 00       	mov    $0x605500,%ecx
  401b7b:	8b 15 57 39 20 00    	mov    0x203957(%rip),%edx        # 6054d8 <check_level>
  401b81:	bf ab 31 40 00       	mov    $0x4031ab,%edi
  401b86:	b8 00 00 00 00       	mov    $0x0,%eax
  401b8b:	e8 60 f1 ff ff       	callq  400cf0 <printf@plt>
  401b90:	bf 01 00 00 00       	mov    $0x1,%edi
  401b95:	e8 b6 f2 ff ff       	callq  400e50 <exit@plt>
...
0000000000401b9a <Gets>:
  ...
  401ba1:	c7 05 59 45 20 00 00 	movl   $0x0,0x204559(%rip)        # 606104 <gets_cnt>
  401ba8:	00 00 00 
  ...
  401bc1:	48 8b 3d 08 39 20 00 	mov    0x203908(%rip),%rdi        # 6054d0 <infile>
  401bc8:	e8 f3 f1 ff ff       	callq  400dc0 <_IO_getc@plt>
...
0000000000401bec <notify_server>:
  ...
  401c03:	8b 05 fb 44 20 00    	mov    0x2044fb(%rip),%eax        # 606104 <gets_cnt>
  401c09:	83 c0 64             	add    $0x64,%eax
  401c0c:	3d 00 20 00 00       	cmp    $0x2000,%eax
  401c11:	7e 19                	jle    401c2c <notify_server+0x40>
  401c13:	bf e0 32 40 00       	mov    $0x4032e0,%edi
  401c18:	b8 00 00 00 00       	mov    $0x0,%eax
  401c1d:	e8 ce f0 ff ff       	callq  400cf0 <printf@plt>
  401c22:	bf 01 00 00 00       	mov    $0x1,%edi
  401c27:	e8 24 f2 ff ff       	callq  400e50 <exit@plt>
  401c2c:	44 0f be 0d d4 44 20 	movsbl 0x2044d4(%rip),%r9d        # 606108 <target_prefix>
  401c33:	00 
  401c34:	83 3d 4d 38 20 00 00 	cmpl   $0x0,0x20384d(%rip)        # 605488 <notify>
  401c3b:	74 09                	je     401c46 <notify_server+0x5a>
  401c3d:	44 8b 05 9c 38 20 00 	mov    0x20389c(%rip),%r8d        # 6054e0 <authkey>
  ...
  401c50:	b9 c1 31 40 00       	mov    $0x4031c1,%ecx
  401c55:	eb 05                	jmp    401c5c <notify_server+0x70>
  401c57:	b9 c6 31 40 00       	mov    $0x4031c6,%ecx
  401c5c:	48 c7 44 24 08 00 55 	movq   $0x605500,0x8(%rsp)
  401c63:	60 00 
  401c65:	89 34 24             	mov    %esi,(%rsp)
  401c68:	8b 15 da 34 20 00    	mov    0x2034da(%rip),%edx        # 605148 <target_id>
  401c6e:	be cb 31 40 00       	mov    $0x4031cb,%esi
  401c73:	48 8d bc 24 10 20 00 	lea    0x2010(%rsp),%rdi
  401c7a:	00 
  401c7b:	b8 00 00 00 00       	mov    $0x0,%eax
  401c80:	e8 bb f1 ff ff       	callq  400e40 <sprintf@plt>
  ...
  401ca4:	00 
  401ca5:	48 8b 15 a4 34 20 00 	mov    0x2034a4(%rip),%rdx        # 605150 <lab>
  401cac:	48 8b 35 a5 34 20 00 	mov    0x2034a5(%rip),%rsi        # 605158 <course>
  401cb3:	48 8b 3d 86 34 20 00 	mov    0x203486(%rip),%rdi        # 605140 <user_id>
  401cba:	e8 c0 0f 00 00       	callq  402c7f <driver_post>
  401cbf:	85 c0                	test   %eax,%eax
  401cc1:	79 1e                	jns    401ce1 <notify_server+0xf5>
  401cc3:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
  401cc8:	bf e7 31 40 00       	mov    $0x4031e7,%edi
  401ccd:	b8 00 00 00 00       	mov    $0x0,%eax
  401cd2:	e8 19 f0 ff ff       	callq  400cf0 <printf@plt>
  401cd7:	bf 01 00 00 00       	mov    $0x1,%edi
  401cdc:	e8 6f f1 ff ff       	callq  400e50 <exit@plt>
  401ce1:	bf 10 33 40 00       	mov    $0x403310,%edi
  401ce6:	e8 d5 ef ff ff       	callq  400cc0 <puts@plt>
  401ceb:	bf f3 31 40 00       	mov    $0x4031f3,%edi
  401cf0:	e8 cb ef ff ff       	callq  400cc0 <puts@plt>
  401cf5:	e9 85 00 00 00       	jmpq   401d7f <notify_server+0x193>
  401cfa:	bf fd 31 40 00       	mov    $0x4031fd,%edi
  401cff:	e8 bc ef ff ff       	callq  400cc0 <puts@plt>
  401d04:	eb 79                	jmp    401d7f <notify_server+0x193>
  401d06:	85 db                	test   %ebx,%ebx
  401d08:	74 08                	je     401d12 <notify_server+0x126>
  401d0a:	be c1 31 40 00       	mov    $0x4031c1,%esi
  401d0f:	90                   	nop
  401d10:	eb 05                	jmp    401d17 <notify_server+0x12b>
  401d12:	be c6 31 40 00       	mov    $0x4031c6,%esi
  401d17:	bf 48 33 40 00       	mov    $0x403348,%edi
  401d1c:	b8 00 00 00 00       	mov    $0x0,%eax
  401d21:	e8 ca ef ff ff       	callq  400cf0 <printf@plt>
  401d26:	48 8b 35 13 34 20 00 	mov    0x203413(%rip),%rsi        # 605140 <user_id>
  401d2d:	bf 04 32 40 00       	mov    $0x403204,%edi
  401d32:	b8 00 00 00 00       	mov    $0x0,%eax
  401d37:	e8 b4 ef ff ff       	callq  400cf0 <printf@plt>
  401d3c:	48 8b 35 15 34 20 00 	mov    0x203415(%rip),%rsi        # 605158 <course>
  401d43:	bf 11 32 40 00       	mov    $0x403211,%edi
  401d48:	b8 00 00 00 00       	mov    $0x0,%eax
  401d4d:	e8 9e ef ff ff       	callq  400cf0 <printf@plt>
  401d52:	48 8b 35 f7 33 20 00 	mov    0x2033f7(%rip),%rsi        # 605150 <lab>
  401d59:	bf 1d 32 40 00       	mov    $0x40321d,%edi
  401d5e:	b8 00 00 00 00       	mov    $0x0,%eax
  401d63:	e8 88 ef ff ff       	callq  400cf0 <printf@plt>
  401d68:	48 8d b4 24 10 20 00 	lea    0x2010(%rsp),%rsi
  401d6f:	00 
  401d70:	bf 26 32 40 00       	mov    $0x403226,%edi
  401d75:	b8 00 00 00 00       	mov    $0x0,%eax
  401d7a:	e8 71 ef ff ff       	callq  400cf0 <printf@plt>
...
0000000000401d89 <validate>:
  ...
  401d8c:	83 3d 55 37 20 00 00 	cmpl   $0x0,0x203755(%rip)        # 6054e8 <is_checker>
  401d93:	74 60                	je     401df5 <validate+0x6c>
  401d95:	39 3d 41 37 20 00    	cmp    %edi,0x203741(%rip)        # 6054dc <vlevel>
  401d9b:	74 14                	je     401db1 <validate+0x28>
  401d9d:	bf 32 32 40 00       	mov    $0x403232,%edi
  401da2:	e8 19 ef ff ff       	callq  400cc0 <puts@plt>
  401da7:	b8 00 00 00 00       	mov    $0x0,%eax
  401dac:	e8 ba fd ff ff       	callq  401b6b <check_fail>
  401db1:	8b 35 21 37 20 00    	mov    0x203721(%rip),%esi        # 6054d8 <check_level>
  401db7:	39 fe                	cmp    %edi,%esi
  401db9:	74 1b                	je     401dd6 <validate+0x4d>
  401dbb:	89 fa                	mov    %edi,%edx
  401dbd:	bf 70 33 40 00       	mov    $0x403370,%edi
  401dc2:	b8 00 00 00 00       	mov    $0x0,%eax
  401dc7:	e8 24 ef ff ff       	callq  400cf0 <printf@plt>
  401dcc:	b8 00 00 00 00       	mov    $0x0,%eax
  401dd1:	e8 95 fd ff ff       	callq  401b6b <check_fail>
  401dd6:	0f be 35 2b 43 20 00 	movsbl 0x20432b(%rip),%esi        # 606108 <target_prefix>
  401ddd:	b9 00 55 60 00       	mov    $0x605500,%ecx
  401de2:	89 fa                	mov    %edi,%edx
  401de4:	bf 50 32 40 00       	mov    $0x403250,%edi
  401de9:	b8 00 00 00 00       	mov    $0x0,%eax
  401dee:	e8 fd ee ff ff       	callq  400cf0 <printf@plt>
  401df3:	eb 44                	jmp    401e39 <validate+0xb0>
  401df5:	39 3d e1 36 20 00    	cmp    %edi,0x2036e1(%rip)        # 6054dc <vlevel>
  401dfb:	74 18                	je     401e15 <validate+0x8c>
  401dfd:	bf 32 32 40 00       	mov    $0x403232,%edi
  401e02:	e8 b9 ee ff ff       	callq  400cc0 <puts@plt>
  ...
  401e15:	0f be 15 ec 42 20 00 	movsbl 0x2042ec(%rip),%edx        # 606108 <target_prefix>
  401e1c:	89 fe                	mov    %edi,%esi
  401e1e:	bf 98 33 40 00       	mov    $0x403398,%edi
  401e23:	b8 00 00 00 00       	mov    $0x0,%eax
  401e28:	e8 c3 ee ff ff       	callq  400cf0 <printf@plt>
...
0000000000401e3b <fail>:
  ...
  401e3f:	83 3d a2 36 20 00 00 	cmpl   $0x0,0x2036a2(%rip)        # 6054e8 <is_checker>
...
0000000000401e63 <bushandler>:
  ...
  401e67:	83 3d 7a 36 20 00 00 	cmpl   $0x0,0x20367a(%rip)        # 6054e8 <is_checker>
  401e6e:	74 14                	je     401e84 <bushandler+0x21>
  401e70:	bf 65 32 40 00       	mov    $0x403265,%edi
  401e75:	e8 46 ee ff ff       	callq  400cc0 <puts@plt>
  401e7a:	b8 00 00 00 00       	mov    $0x0,%eax
  401e7f:	e8 e7 fc ff ff       	callq  401b6b <check_fail>
  401e84:	bf d0 33 40 00       	mov    $0x4033d0,%edi
  401e89:	e8 32 ee ff ff       	callq  400cc0 <puts@plt>
  401e8e:	bf 6f 32 40 00       	mov    $0x40326f,%edi
  ...
  401eac:	e8 9f ef ff ff       	callq  400e50 <exit@plt>

0000000000401eb1 <seghandler>:
  401eb1:	48 83 ec 08          	sub    $0x8,%rsp
  401eb5:	83 3d 2c 36 20 00 00 	cmpl   $0x0,0x20362c(%rip)        # 6054e8 <is_checker>
  401ebc:	74 14                	je     401ed2 <seghandler+0x21>
  401ebe:	bf 85 32 40 00       	mov    $0x403285,%edi
  401ec3:	e8 f8 ed ff ff       	callq  400cc0 <puts@plt>
  401ec8:	b8 00 00 00 00       	mov    $0x0,%eax
  401ecd:	e8 99 fc ff ff       	callq  401b6b <check_fail>
  401ed2:	bf f0 33 40 00       	mov    $0x4033f0,%edi
  401ed7:	e8 e4 ed ff ff       	callq  400cc0 <puts@plt>
  401edc:	bf 6f 32 40 00       	mov    $0x40326f,%edi
  ...
  401efa:	e8 51 ef ff ff       	callq  400e50 <exit@plt>

0000000000401eff <illegalhandler>:
  401eff:	48 83 ec 08          	sub    $0x8,%rsp
  401f03:	83 3d de 35 20 00 00 	cmpl   $0x0,0x2035de(%rip)        # 6054e8 <is_checker>
  401f0a:	74 14                	je     401f20 <illegalhandler+0x21>
  401f0c:	bf 98 32 40 00       	mov    $0x403298,%edi
  401f11:	e8 aa ed ff ff       	callq  400cc0 <puts@plt>
  401f16:	b8 00 00 00 00       	mov    $0x0,%eax
  401f1b:	e8 4b fc ff ff       	callq  401b6b <check_fail>
  401f20:	bf 18 34 40 00       	mov    $0x403418,%edi
  401f25:	e8 96 ed ff ff       	callq  400cc0 <puts@plt>
  401f2a:	bf 6f 32 40 00       	mov    $0x40326f,%edi
  ...
  401f48:	e8 03 ef ff ff       	callq  400e50 <exit@plt>

0000000000401f4d <sigalrmhandler>:
  401f4d:	48 83 ec 08          	sub    $0x8,%rsp
  401f51:	83 3d 90 35 20 00 00 	cmpl   $0x0,0x203590(%rip)        # 6054e8 <is_checker>
  401f58:	74 14                	je     401f6e <sigalrmhandler+0x21>
  401f5a:	bf ac 32 40 00       	mov    $0x4032ac,%edi
  ...
  401f73:	bf 48 34 40 00       	mov    $0x403448,%edi
  401f78:	b8 00 00 00 00       	mov    $0x0,%eax
  401f7d:	e8 6e ed ff ff       	callq  400cf0 <printf@plt>
  ...
  401f96:	e8 b5 ee ff ff       	callq  400e50 <exit@plt>
...
0000000000401f9b <launch>:
  ...
  401fbb:	e8 40 ed ff ff       	callq  400d00 <memset@plt>
  401fc0:	48 8b 05 d9 34 20 00 	mov    0x2034d9(%rip),%rax        # 6054a0 <stdin@@GLIBC_2.2.5>
  401fc7:	48 39 05 02 35 20 00 	cmp    %rax,0x203502(%rip)        # 6054d0 <infile>
  401fce:	75 0f                	jne    401fdf <launch+0x44>
  401fd0:	bf b4 32 40 00       	mov    $0x4032b4,%edi
  401fd5:	b8 00 00 00 00       	mov    $0x0,%eax
  401fda:	e8 11 ed ff ff       	callq  400cf0 <printf@plt>
  401fdf:	c7 05 f3 34 20 00 00 	movl   $0x0,0x2034f3(%rip)        # 6054dc <vlevel>
  401fe6:	00 00 00 
  401fe9:	b8 00 00 00 00       	mov    $0x0,%eax
  401fee:	e8 c0 f9 ff ff       	callq  4019b3 <test>
  401ff3:	83 3d ee 34 20 00 00 	cmpl   $0x0,0x2034ee(%rip)        # 6054e8 <is_checker>
  401ffa:	74 14                	je     402010 <launch+0x75>
  401ffc:	bf c1 32 40 00       	mov    $0x4032c1,%edi
  402001:	e8 ba ec ff ff       	callq  400cc0 <puts@plt>
  402006:	b8 00 00 00 00       	mov    $0x0,%eax
  40200b:	e8 5b fb ff ff       	callq  401b6b <check_fail>
  402010:	bf cc 32 40 00       	mov    $0x4032cc,%edi
  402015:	e8 a6 ec ff ff       	callq  400cc0 <puts@plt>
  40201a:	c9                   	leaveq 
  40201b:	c3                   	retq   

000000000040201c <stable_launch>:
  40201c:	53                   	push   %rbx
  40201d:	48 89 3d a4 34 20 00 	mov    %rdi,0x2034a4(%rip)        # 6054c8 <global_offset>
  ...
  402044:	e8 97 ec ff ff       	callq  400ce0 <mmap@plt>
  ...
  40205c:	e8 7f ed ff ff       	callq  400de0 <munmap@plt>
  402061:	ba 00 60 58 55       	mov    $0x55586000,%edx
  402066:	be 80 34 40 00       	mov    $0x403480,%esi
  40206b:	48 8b 3d 3e 34 20 00 	mov    0x20343e(%rip),%rdi        # 6054b0 <stderr@@GLIBC_2.2.5>
  402072:	b8 00 00 00 00       	mov    $0x0,%eax
  402077:	e8 f4 ec ff ff       	callq  400d70 <fprintf@plt>
  40207c:	bf 01 00 00 00       	mov    $0x1,%edi
  402081:	e8 ca ed ff ff       	callq  400e50 <exit@plt>
  402086:	48 8d 90 f8 ff 0f 00 	lea    0xffff8(%rax),%rdx
  40208d:	48 89 15 7c 40 20 00 	mov    %rdx,0x20407c(%rip)        # 606110 <stack_top>
  402094:	48 89 e0             	mov    %rsp,%rax
  402097:	48 89 d4             	mov    %rdx,%rsp
  40209a:	48 89 c2             	mov    %rax,%rdx
  40209d:	48 89 15 1c 34 20 00 	mov    %rdx,0x20341c(%rip)        # 6054c0 <global_save_stack>
  4020a4:	48 8b 3d 1d 34 20 00 	mov    0x20341d(%rip),%rdi        # 6054c8 <global_offset>
  4020ab:	e8 eb fe ff ff       	callq  401f9b <launch>
  4020b0:	48 8b 05 09 34 20 00 	mov    0x203409(%rip),%rax        # 6054c0 <global_save_stack>
  4020b7:	48 89 c4             	mov    %rax,%rsp
  4020ba:	be 00 00 10 00       	mov    $0x100000,%esi
  4020bf:	48 89 df             	mov    %rbx,%rdi
  4020c2:	e8 19 ed ff ff       	callq  400de0 <munmap@plt>
  4020c7:	5b                   	pop    %rbx
  4020c8:	c3                   	retq   
...
00000000004020e2 <sigalrm_handler>:
  ...
  4020eb:	be c0 34 40 00       	mov    $0x4034c0,%esi
  4020f0:	48 8b 3d b9 33 20 00 	mov    0x2033b9(%rip),%rdi        # 6054b0 <stderr@@GLIBC_2.2.5>
  4020f7:	b8 00 00 00 00       	mov    $0x0,%eax
  4020fc:	e8 6f ec ff ff       	callq  400d70 <fprintf@plt>
  402101:	bf 01 00 00 00       	mov    $0x1,%edi
  402106:	e8 45 ed ff ff       	callq  400e50 <exit@plt>
...
000000000040210b <urlencode>:
  ...
  402191:	be 58 35 40 00       	mov    $0x403558,%esi
  402196:	48 89 e7             	mov    %rsp,%rdi
  402199:	b8 00 00 00 00       	mov    $0x0,%eax
  40219e:	e8 9d ec ff ff       	callq  400e40 <sprintf@plt>
...
00000000004021e1 <rio_writen>:
  ...
  402202:	e8 c9 ea ff ff       	callq  400cd0 <write@plt>
  402207:	48 85 c0             	test   %rax,%rax
  40220a:	7f 0f                	jg     40221b <rio_writen+0x3a>
  40220c:	e8 6f ea ff ff       	callq  400c80 <__errno_location@plt>
...
000000000040223d <rio_read>:
  ...
  40225e:	e8 cd ea ff ff       	callq  400d30 <read@plt>
  402263:	89 43 04             	mov    %eax,0x4(%rbx)
  402266:	85 c0                	test   %eax,%eax
  402268:	79 0c                	jns    402276 <rio_read+0x39>
  40226a:	e8 11 ea ff ff       	callq  400c80 <__errno_location@plt>
  ...
  40229c:	e8 ef ea ff ff       	callq  400d90 <memcpy@plt>
...
0000000000402347 <submitr>:
  ...
  40238f:	e8 dc ea ff ff       	callq  400e70 <socket@plt>
  ...
  4023e3:	e9 94 06 00 00       	jmpq   402a7c <submitr+0x735>
  4023e8:	4c 89 e7             	mov    %r12,%rdi
  4023eb:	e8 70 e9 ff ff       	callq  400d60 <gethostbyname@plt>
  ...
  40244d:	e8 ce e8 ff ff       	callq  400d20 <close@plt>
  402452:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  402457:	e9 20 06 00 00       	jmpq   402a7c <submitr+0x735>
  ...
  402491:	e8 5a e9 ff ff       	callq  400df0 <bcopy@plt>
  ...
  4024b6:	e8 a5 e9 ff ff       	callq  400e60 <connect@plt>
  ...
  402509:	e8 12 e8 ff ff       	callq  400d20 <close@plt>
  40250e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  402513:	e9 64 05 00 00       	jmpq   402a7c <submitr+0x735>
  ...
  4025cd:	e8 4e e7 ff ff       	callq  400d20 <close@plt>
  4025d2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  4025d7:	e9 a0 04 00 00       	jmpq   402a7c <submitr+0x735>
  ...
  402689:	e9 ee 03 00 00       	jmpq   402a7c <submitr+0x735>
  ...
  40269f:	be e8 34 40 00       	mov    $0x4034e8,%esi
  4026a4:	48 8d bc 24 20 60 00 	lea    0x6020(%rsp),%rdi
  4026ab:	00 
  4026ac:	b8 00 00 00 00       	mov    $0x0,%eax
  4026b1:	e8 8a e7 ff ff       	callq  400e40 <sprintf@plt>
  ...
  402746:	e8 d5 e5 ff ff       	callq  400d20 <close@plt>
  40274b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  402750:	e9 27 03 00 00       	jmpq   402a7c <submitr+0x735>
  ...
  4027f1:	e8 2a e5 ff ff       	callq  400d20 <close@plt>
  4027f6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  4027fb:	e9 7c 02 00 00       	jmpq   402a7c <submitr+0x735>
  ...
  402814:	00 
  402815:	be 5f 35 40 00       	mov    $0x40355f,%esi
  40281a:	48 8d bc 24 20 60 00 	lea    0x6020(%rsp),%rdi
  402821:	00 
  402822:	b8 00 00 00 00       	mov    $0x0,%eax
  402827:	e8 a4 e5 ff ff       	callq  400dd0 <__isoc99_sscanf@plt>
  40282c:	41 bc 0d 00 00 00    	mov    $0xd,%r12d
  402832:	41 bd 0a 00 00 00    	mov    $0xa,%r13d
  402838:	e9 98 00 00 00       	jmpq   4028d5 <submitr+0x58e>
  40283d:	ba 00 20 00 00       	mov    $0x2000,%edx
  402842:	48 8d b4 24 20 60 00 	lea    0x6020(%rsp),%rsi
  402849:	00 
  40284a:	48 8d bc 24 20 80 00 	lea    0x8020(%rsp),%rdi
  402851:	00 
  402852:	e8 6d fa ff ff       	callq  4022c4 <rio_readlineb>
  402857:	48 85 c0             	test   %rax,%rax
  40285a:	7f 79                	jg     4028d5 <submitr+0x58e>
  40285c:	48 b8 45 72 72 6f 72 	movabs $0x43203a726f727245,%rax
  402863:	3a 20 43 
  402866:	48 89 03             	mov    %rax,(%rbx)
  402869:	48 b8 6c 69 65 6e 74 	movabs $0x6e7520746e65696c,%rax
  402870:	20 75 6e 
  402873:	48 89 43 08          	mov    %rax,0x8(%rbx)
  402877:	48 b8 61 62 6c 65 20 	movabs $0x206f7420656c6261,%rax
  40287e:	74 6f 20 
  402881:	48 89 43 10          	mov    %rax,0x10(%rbx)
  402885:	48 b8 72 65 61 64 20 	movabs $0x6165682064616572,%rax
  40288c:	68 65 61 
  40288f:	48 89 43 18          	mov    %rax,0x18(%rbx)
  402893:	48 b8 64 65 72 73 20 	movabs $0x6f72662073726564,%rax
  40289a:	66 72 6f 
  40289d:	48 89 43 20          	mov    %rax,0x20(%rbx)
  4028a1:	48 b8 6d 20 74 68 65 	movabs $0x657220656874206d,%rax
  4028a8:	20 72 65 
  4028ab:	48 89 43 28          	mov    %rax,0x28(%rbx)
  4028af:	48 b8 73 75 6c 74 20 	movabs $0x72657320746c7573,%rax
  4028b6:	73 65 72 
  4028b9:	48 89 43 30          	mov    %rax,0x30(%rbx)
  4028bd:	c7 43 38 76 65 72 00 	movl   $0x726576,0x38(%rbx)
  4028c4:	89 ef                	mov    %ebp,%edi
  4028c6:	e8 55 e4 ff ff       	callq  400d20 <close@plt>
  4028cb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  4028d0:	e9 a7 01 00 00       	jmpq   402a7c <submitr+0x735>
  4028d5:	0f b6 84 24 20 60 00 	movzbl 0x6020(%rsp),%eax
  4028dc:	00 
  4028dd:	44 89 e6             	mov    %r12d,%esi
  4028e0:	29 c6                	sub    %eax,%esi
  4028e2:	89 f0                	mov    %esi,%eax
  4028e4:	75 1b                	jne    402901 <submitr+0x5ba>
  4028e6:	0f b6 84 24 21 60 00 	movzbl 0x6021(%rsp),%eax
  4028ed:	00 
  4028ee:	44 89 ea             	mov    %r13d,%edx
  4028f1:	29 c2                	sub    %eax,%edx
  4028f3:	89 d0                	mov    %edx,%eax
  4028f5:	75 0a                	jne    402901 <submitr+0x5ba>
  4028f7:	0f b6 84 24 22 60 00 	movzbl 0x6022(%rsp),%eax
  4028fe:	00 
  4028ff:	f7 d8                	neg    %eax
  402901:	85 c0                	test   %eax,%eax
  402903:	0f 85 34 ff ff ff    	jne    40283d <submitr+0x4f6>
  402909:	ba 00 20 00 00       	mov    $0x2000,%edx
  40290e:	48 8d b4 24 20 60 00 	lea    0x6020(%rsp),%rsi
  402915:	00 
  402916:	48 8d bc 24 20 80 00 	lea    0x8020(%rsp),%rdi
  40291d:	00 
  40291e:	e8 a1 f9 ff ff       	callq  4022c4 <rio_readlineb>
  402923:	48 85 c0             	test   %rax,%rax
  402926:	0f 8f 83 00 00 00    	jg     4029af <submitr+0x668>
  40292c:	48 b8 45 72 72 6f 72 	movabs $0x43203a726f727245,%rax
  402933:	3a 20 43 
  402936:	48 89 03             	mov    %rax,(%rbx)
  402939:	48 b8 6c 69 65 6e 74 	movabs $0x6e7520746e65696c,%rax
  402940:	20 75 6e 
  402943:	48 89 43 08          	mov    %rax,0x8(%rbx)
  402947:	48 b8 61 62 6c 65 20 	movabs $0x206f7420656c6261,%rax
  40294e:	74 6f 20 
  402951:	48 89 43 10          	mov    %rax,0x10(%rbx)
  402955:	48 b8 72 65 61 64 20 	movabs $0x6174732064616572,%rax
  40295c:	73 74 61 
  40295f:	48 89 43 18          	mov    %rax,0x18(%rbx)
  402963:	48 b8 74 75 73 20 6d 	movabs $0x7373656d20737574,%rax
  40296a:	65 73 73 
  40296d:	48 89 43 20          	mov    %rax,0x20(%rbx)
  402971:	48 b8 61 67 65 20 66 	movabs $0x6d6f726620656761,%rax
  402978:	72 6f 6d 
  40297b:	48 89 43 28          	mov    %rax,0x28(%rbx)
  40297f:	48 b8 20 72 65 73 75 	movabs $0x20746c7573657220,%rax
  402986:	6c 74 20 
  402989:	48 89 43 30          	mov    %rax,0x30(%rbx)
  40298d:	c7 43 38 73 65 72 76 	movl   $0x76726573,0x38(%rbx)
  402994:	66 c7 43 3c 65 72    	movw   $0x7265,0x3c(%rbx)
  40299a:	c6 43 3e 00          	movb   $0x0,0x3e(%rbx)
  40299e:	89 ef                	mov    %ebp,%edi
  4029a0:	e8 7b e3 ff ff       	callq  400d20 <close@plt>
  4029a5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  4029aa:	e9 cd 00 00 00       	jmpq   402a7c <submitr+0x735>
  4029af:	8b 94 24 1c 20 00 00 	mov    0x201c(%rsp),%edx
  4029b6:	81 fa c8 00 00 00    	cmp    $0xc8,%edx
  4029bc:	74 28                	je     4029e6 <submitr+0x69f>
  4029be:	48 8d 4c 24 10       	lea    0x10(%rsp),%rcx
  4029c3:	be 28 35 40 00       	mov    $0x403528,%esi
  4029c8:	48 89 df             	mov    %rbx,%rdi
  4029cb:	b8 00 00 00 00       	mov    $0x0,%eax
  4029d0:	e8 6b e4 ff ff       	callq  400e40 <sprintf@plt>
  4029d5:	89 ef                	mov    %ebp,%edi
  4029d7:	e8 44 e3 ff ff       	callq  400d20 <close@plt>
  4029dc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  4029e1:	e9 96 00 00 00       	jmpq   402a7c <submitr+0x735>
  4029e6:	48 8d b4 24 20 60 00 	lea    0x6020(%rsp),%rsi
  4029ed:	00 
  4029ee:	48 89 df             	mov    %rbx,%rdi
  4029f1:	e8 ba e2 ff ff       	callq  400cb0 <strcpy@plt>
  4029f6:	89 ef                	mov    %ebp,%edi
  4029f8:	e8 23 e3 ff ff       	callq  400d20 <close@plt>
  4029fd:	0f b6 03             	movzbl (%rbx),%eax
  402a00:	ba 4f 00 00 00       	mov    $0x4f,%edx
  402a05:	29 c2                	sub    %eax,%edx
  402a07:	75 22                	jne    402a2b <submitr+0x6e4>
  402a09:	0f b6 4b 01          	movzbl 0x1(%rbx),%ecx
  402a0d:	b8 4b 00 00 00       	mov    $0x4b,%eax
  402a12:	29 c8                	sub    %ecx,%eax
  402a14:	75 17                	jne    402a2d <submitr+0x6e6>
  402a16:	0f b6 4b 02          	movzbl 0x2(%rbx),%ecx
  402a1a:	b8 0a 00 00 00       	mov    $0xa,%eax
  402a1f:	29 c8                	sub    %ecx,%eax
  402a21:	75 0a                	jne    402a2d <submitr+0x6e6>
  402a23:	0f b6 43 03          	movzbl 0x3(%rbx),%eax
  402a27:	f7 d8                	neg    %eax
  402a29:	eb 02                	jmp    402a2d <submitr+0x6e6>
  402a2b:	89 d0                	mov    %edx,%eax
  402a2d:	85 c0                	test   %eax,%eax
  402a2f:	74 38                	je     402a69 <submitr+0x722>
  402a31:	bf 70 35 40 00       	mov    $0x403570,%edi
  402a36:	b9 05 00 00 00       	mov    $0x5,%ecx
  402a3b:	48 89 de             	mov    %rbx,%rsi
  402a3e:	f3 a6                	repz cmpsb %es:(%rdi),%ds:(%rsi)
  402a40:	0f 97 c1             	seta   %cl
  402a43:	0f 92 c0             	setb   %al
  402a46:	38 c1                	cmp    %al,%cl
  402a48:	74 26                	je     402a70 <submitr+0x729>
  402a4a:	85 d2                	test   %edx,%edx
  402a4c:	75 10                	jne    402a5e <submitr+0x717>
  402a4e:	0f b6 43 01          	movzbl 0x1(%rbx),%eax
  402a52:	b2 4b                	mov    $0x4b,%dl
  402a54:	29 c2                	sub    %eax,%edx
  402a56:	75 06                	jne    402a5e <submitr+0x717>
  402a58:	0f b6 53 02          	movzbl 0x2(%rbx),%edx
  402a5c:	f7 da                	neg    %edx
  402a5e:	85 d2                	test   %edx,%edx
  402a60:	75 15                	jne    402a77 <submitr+0x730>
  402a62:	b8 00 00 00 00       	mov    $0x0,%eax
  402a67:	eb 13                	jmp    402a7c <submitr+0x735>
  402a69:	b8 00 00 00 00       	mov    $0x0,%eax
  402a6e:	eb 0c                	jmp    402a7c <submitr+0x735>
  402a70:	b8 00 00 00 00       	mov    $0x0,%eax
  402a75:	eb 05                	jmp    402a7c <submitr+0x735>
  402a77:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  402a7c:	48 81 c4 48 a0 00 00 	add    $0xa048,%rsp
  402a83:	5b                   	pop    %rbx
  402a84:	5d                   	pop    %rbp
  402a85:	41 5c                	pop    %r12
  402a87:	41 5d                	pop    %r13
  402a89:	41 5e                	pop    %r14
  402a8b:	41 5f                	pop    %r15
  402a8d:	c3                   	retq   

0000000000402a8e <init_timeout>:
  402a8e:	53                   	push   %rbx
  402a8f:	89 fb                	mov    %edi,%ebx
  402a91:	85 ff                	test   %edi,%edi
  402a93:	74 1f                	je     402ab4 <init_timeout+0x26>
  402a95:	85 ff                	test   %edi,%edi
  402a97:	79 05                	jns    402a9e <init_timeout+0x10>
  402a99:	bb 00 00 00 00       	mov    $0x0,%ebx
  402a9e:	be e2 20 40 00       	mov    $0x4020e2,%esi
  402aa3:	bf 0e 00 00 00       	mov    $0xe,%edi
  402aa8:	e8 a3 e2 ff ff       	callq  400d50 <signal@plt>
  402aad:	89 df                	mov    %ebx,%edi
  402aaf:	e8 5c e2 ff ff       	callq  400d10 <alarm@plt>
  402ab4:	5b                   	pop    %rbx
  402ab5:	c3                   	retq   

0000000000402ab6 <init_driver>:
  402ab6:	55                   	push   %rbp
  402ab7:	53                   	push   %rbx
  402ab8:	48 83 ec 18          	sub    $0x18,%rsp
  402abc:	48 89 fd             	mov    %rdi,%rbp
  402abf:	be 01 00 00 00       	mov    $0x1,%esi
  402ac4:	bf 0d 00 00 00       	mov    $0xd,%edi
  402ac9:	e8 82 e2 ff ff       	callq  400d50 <signal@plt>
  402ace:	be 01 00 00 00       	mov    $0x1,%esi
  402ad3:	bf 1d 00 00 00       	mov    $0x1d,%edi
  402ad8:	e8 73 e2 ff ff       	callq  400d50 <signal@plt>
  402add:	be 01 00 00 00       	mov    $0x1,%esi
  402ae2:	bf 1d 00 00 00       	mov    $0x1d,%edi
  402ae7:	e8 64 e2 ff ff       	callq  400d50 <signal@plt>
  402aec:	ba 00 00 00 00       	mov    $0x0,%edx
  402af1:	be 01 00 00 00       	mov    $0x1,%esi
  402af6:	bf 02 00 00 00       	mov    $0x2,%edi
  402afb:	e8 70 e3 ff ff       	callq  400e70 <socket@plt>
  402b00:	89 c3                	mov    %eax,%ebx
  402b02:	85 c0                	test   %eax,%eax
  402b04:	79 4f                	jns    402b55 <init_driver+0x9f>
  402b06:	48 b8 45 72 72 6f 72 	movabs $0x43203a726f727245,%rax
  402b0d:	3a 20 43 
  402b10:	48 89 45 00          	mov    %rax,0x0(%rbp)
  402b14:	48 b8 6c 69 65 6e 74 	movabs $0x6e7520746e65696c,%rax
  402b1b:	20 75 6e 
  402b1e:	48 89 45 08          	mov    %rax,0x8(%rbp)
  402b22:	48 b8 61 62 6c 65 20 	movabs $0x206f7420656c6261,%rax
  402b29:	74 6f 20 
  402b2c:	48 89 45 10          	mov    %rax,0x10(%rbp)
  402b30:	48 b8 63 72 65 61 74 	movabs $0x7320657461657263,%rax
  402b37:	65 20 73 
  402b3a:	48 89 45 18          	mov    %rax,0x18(%rbp)
  402b3e:	c7 45 20 6f 63 6b 65 	movl   $0x656b636f,0x20(%rbp)
  402b45:	66 c7 45 24 74 00    	movw   $0x74,0x24(%rbp)
  402b4b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  402b50:	e9 23 01 00 00       	jmpq   402c78 <init_driver+0x1c2>
  402b55:	bf 75 35 40 00       	mov    $0x403575,%edi
  402b5a:	e8 01 e2 ff ff       	callq  400d60 <gethostbyname@plt>
  402b5f:	48 85 c0             	test   %rax,%rax
  402b62:	75 68                	jne    402bcc <init_driver+0x116>
  402b64:	48 b8 45 72 72 6f 72 	movabs $0x44203a726f727245,%rax
  402b6b:	3a 20 44 
  402b6e:	48 89 45 00          	mov    %rax,0x0(%rbp)
  402b72:	48 b8 4e 53 20 69 73 	movabs $0x6e7520736920534e,%rax
  402b79:	20 75 6e 
  402b7c:	48 89 45 08          	mov    %rax,0x8(%rbp)
  402b80:	48 b8 61 62 6c 65 20 	movabs $0x206f7420656c6261,%rax
  402b87:	74 6f 20 
  402b8a:	48 89 45 10          	mov    %rax,0x10(%rbp)
  402b8e:	48 b8 72 65 73 6f 6c 	movabs $0x2065766c6f736572,%rax
  402b95:	76 65 20 
  402b98:	48 89 45 18          	mov    %rax,0x18(%rbp)
  402b9c:	48 b8 73 65 72 76 65 	movabs $0x6120726576726573,%rax
  402ba3:	72 20 61 
  402ba6:	48 89 45 20          	mov    %rax,0x20(%rbp)
  402baa:	c7 45 28 64 64 72 65 	movl   $0x65726464,0x28(%rbp)
  402bb1:	66 c7 45 2c 73 73    	movw   $0x7373,0x2c(%rbp)
  402bb7:	c6 45 2e 00          	movb   $0x0,0x2e(%rbp)
  402bbb:	89 df                	mov    %ebx,%edi
  402bbd:	e8 5e e1 ff ff       	callq  400d20 <close@plt>
  402bc2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  402bc7:	e9 ac 00 00 00       	jmpq   402c78 <init_driver+0x1c2>
  402bcc:	48 c7 04 24 00 00 00 	movq   $0x0,(%rsp)
  402bd3:	00 
  402bd4:	48 c7 44 24 08 00 00 	movq   $0x0,0x8(%rsp)
  402bdb:	00 00 
  402bdd:	66 c7 04 24 02 00    	movw   $0x2,(%rsp)
  402be3:	48 8b 48 18          	mov    0x18(%rax),%rcx
  402be7:	48 63 50 14          	movslq 0x14(%rax),%rdx
  402beb:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
  402bf0:	48 8b 39             	mov    (%rcx),%rdi
  402bf3:	e8 f8 e1 ff ff       	callq  400df0 <bcopy@plt>
  402bf8:	66 c7 44 24 02 3c 9a 	movw   $0x9a3c,0x2(%rsp)
  402bff:	ba 10 00 00 00       	mov    $0x10,%edx
  402c04:	48 89 e6             	mov    %rsp,%rsi
  402c07:	89 df                	mov    %ebx,%edi
  402c09:	e8 52 e2 ff ff       	callq  400e60 <connect@plt>
  402c0e:	85 c0                	test   %eax,%eax
  402c10:	79 50                	jns    402c62 <init_driver+0x1ac>
  402c12:	48 b8 45 72 72 6f 72 	movabs $0x55203a726f727245,%rax
  402c19:	3a 20 55 
  402c1c:	48 89 45 00          	mov    %rax,0x0(%rbp)
  402c20:	48 b8 6e 61 62 6c 65 	movabs $0x6f7420656c62616e,%rax
  402c27:	20 74 6f 
  402c2a:	48 89 45 08          	mov    %rax,0x8(%rbp)
  402c2e:	48 b8 20 63 6f 6e 6e 	movabs $0x7463656e6e6f6320,%rax
  402c35:	65 63 74 
  402c38:	48 89 45 10          	mov    %rax,0x10(%rbp)
  402c3c:	48 b8 20 74 6f 20 73 	movabs $0x76726573206f7420,%rax
  402c43:	65 72 76 
  402c46:	48 89 45 18          	mov    %rax,0x18(%rbp)
  402c4a:	66 c7 45 20 65 72    	movw   $0x7265,0x20(%rbp)
  402c50:	c6 45 22 00          	movb   $0x0,0x22(%rbp)
  402c54:	89 df                	mov    %ebx,%edi
  402c56:	e8 c5 e0 ff ff       	callq  400d20 <close@plt>
  402c5b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  402c60:	eb 16                	jmp    402c78 <init_driver+0x1c2>
  402c62:	89 df                	mov    %ebx,%edi
  402c64:	e8 b7 e0 ff ff       	callq  400d20 <close@plt>
  402c69:	66 c7 45 00 4f 4b    	movw   $0x4b4f,0x0(%rbp)
  402c6f:	c6 45 02 00          	movb   $0x0,0x2(%rbp)
...
0000000000402c7f <driver_post>:
  402c7f:	53                   	push   %rbx
  402c80:	48 83 ec 10          	sub    $0x10,%rsp
  402c84:	4c 89 cb             	mov    %r9,%rbx
  402c87:	45 85 c0             	test   %r8d,%r8d
  402c8a:	74 22                	je     402cae <driver_post+0x2f>
  402c8c:	48 89 ce             	mov    %rcx,%rsi
  402c8f:	bf 87 35 40 00       	mov    $0x403587,%edi
  402c94:	b8 00 00 00 00       	mov    $0x0,%eax
  402c99:	e8 52 e0 ff ff       	callq  400cf0 <printf@plt>
  402c9e:	66 c7 03 4f 4b       	movw   $0x4b4f,(%rbx)
  402ca3:	c6 43 02 00          	movb   $0x0,0x2(%rbx)
  402ca7:	b8 00 00 00 00       	mov    $0x0,%eax
  402cac:	eb 39                	jmp    402ce7 <driver_post+0x68>
  402cae:	48 85 ff             	test   %rdi,%rdi
  402cb1:	74 26                	je     402cd9 <driver_post+0x5a>
  402cb3:	80 3f 00             	cmpb   $0x0,(%rdi)
  402cb6:	74 21                	je     402cd9 <driver_post+0x5a>
  402cb8:	4c 89 0c 24          	mov    %r9,(%rsp)
  ...
  402ccd:	bf 75 35 40 00       	mov    $0x403575,%edi
  402cd2:	e8 70 f6 ff ff       	callq  402347 <submitr>
  402cd7:	eb 0e                	jmp    402ce7 <driver_post+0x68>
  402cd9:	66 c7 03 4f 4b       	movw   $0x4b4f,(%rbx)
  402cde:	c6 43 02 00          	movb   $0x0,0x2(%rbx)
  402ce2:	b8 00 00 00 00       	mov    $0x0,%eax
  402ce7:	48 83 c4 10          	add    $0x10,%rsp
  402ceb:	5b                   	pop    %rbx
  402cec:	c3                   	retq   
...
0000000000402d1f <gencookie>:
  ...
  402d23:	e8 68 df ff ff       	callq  400c90 <srandom@plt>
  402d28:	e8 83 e0 ff ff       	callq  400db0 <random@plt>
...
0000000000402d40 <__libc_csu_init>:
  ...
  402d51:	4c 8d 25 a8 20 20 00 	lea    0x2020a8(%rip),%r12        # 604e00 <__frame_dummy_init_array_entry>
  402d58:	55                   	push   %rbp
  402d59:	48 8d 2d a8 20 20 00 	lea    0x2020a8(%rip),%rbp        # 604e08 <__init_array_end>
  402d60:	53                   	push   %rbx
  402d61:	4c 29 e5             	sub    %r12,%rbp
  402d64:	31 db                	xor    %ebx,%ebx
  402d66:	48 c1 fd 03          	sar    $0x3,%rbp
  402d6a:	48 83 ec 08          	sub    $0x8,%rsp
  402d6e:	e8 dd de ff ff       	callq  400c50 <_init>
